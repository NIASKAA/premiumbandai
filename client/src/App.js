...
import {Home, HighGrade, RealGrade, MasterGrade, PerfectGrade, SDGrade, Converges, Others, Login, SignUp, Profile, FAQ} from './Pages'
          ...
          <Router>
            <Navigation />
              <Switch>
                ...
                <Route path="/converges" component={Converges}/>
